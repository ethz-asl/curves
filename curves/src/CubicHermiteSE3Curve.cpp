...
////      std::cout << "w3: " << w3.transpose() << std::endl;
//
...
//
//      RotationQuaternion w1_dbeta1;
//      {
//        Eigen::Vector3d vec = Eigen::Vector3d(dbeta1*w1);
//        if (vec.isZero()) {
//          w1_dbeta1.setParts(1.0, Eigen::Vector3d::Zero());
//        } else {
//          w1_dbeta1.setParts(0.0, vec);
//        }
//      }
//
//      RotationQuaternion w2_dbeta2;
//      {
//        Eigen::Vector3d vec = Eigen::Vector3d(dbeta2*w2);
//        if (vec.isZero()) {
//          w2_dbeta2.setParts(1.0, Eigen::Vector3d::Zero());
//        } else {
//          w2_dbeta2.setParts(0.0, vec);
//        }
//      }
//
//      RotationQuaternion w3_dbeta3;
//      {
//        Eigen::Vector3d vec = Eigen::Vector3d(dbeta3*w3);
//        if (vec.isZero()) {
//          w3_dbeta3.setParts(1.0, Eigen::Vector3d::Zero());
//        } else {
//          w3_dbeta3.setParts(0.0, vec);
//        }
//      }
//
...
//    std::cout << "called derivative 1!" << std::endl;
    ...
    if (manager_.getMaxTime() == time && manager_.getMinTime() == time) {
      ...
      const Eigen::Vector3d w1 = T_W_A.getRotation().inverseRotate(scaled_d_W_A);
      const Eigen::Vector3d w3 = T_W_B.getRotation().inverseRotate(scaled_d_W_B);
//      std::cout << "exp map w" << std::endl;
      const RotationQuaternion expW1_inv = RotationQuaternion().exponentialMap(-w1);
      const RotationQuaternion expW3_inv = RotationQuaternion().exponentialMap(-w3);
//      std::cout << "exp map" << std::endl;

      const RotationQuaternion expW1_Inv_qWB_expW3 = expW1_inv * T_W_A.getRotation().inverted() * T_W_B.getRotation() * expW3_inv;

      const Eigen::Vector3d w2 = expW1_Inv_qWB_expW3.logarithmicMap();

//      std::cout << "exp map beta" << std::endl;
      const SO3 w1_beta1_exp = RotationQuaternion().exponentialMap((beta1) * w1);
      const SO3 w2_beta2_exp = RotationQuaternion().exponentialMap((beta2) * w2);
      const SO3 w3_beta3_exp = RotationQuaternion().exponentialMap((beta3) * w3);
//      std::cout << "did exp map" << std::endl;
...
//      RotationQuaternion w1_dbeta1;
//      w1_dbeta1.setParts(0.0, Eigen::Vector3d(dbeta1*w1));
//      RotationQuaternion w2_dbeta2;
//      w2_dbeta2.setParts(0.0, Eigen::Vector3d(dbeta2*w2));
//      RotationQuaternion w3_dbeta3;
//      w3_dbeta3.setParts(0.0, Eigen::Vector3d(dbeta3*w3));
...
//      RotationQuaternion w2_dbeta2(0.0, dbeta2 * w2);
//      RotationQuaternion w3_dbeta3(0.0, dbeta3 * w3);
//      std::cout << "dbeta" << std::endl;

      const RotationQuaternion rotationTwa = T_W_A.getRotation();
//      std::cout << "got rotation twa" << std::endl;

      const Eigen::Vector4d diff = ((rotationTwa * w1_beta1_exp * w1_dbeta1    * w2_beta2_exp * w3_beta3_exp).vector()
                                  + (rotationTwa * w1_beta1_exp * w2_beta2_exp * w2_dbeta2    * w3_beta3_exp).vector()
                                  + (rotationTwa * w1_beta1_exp * w2_beta2_exp * w3_beta3_exp * w3_dbeta3   ).vector())*one_over_dt_sec;
...
//      std::cout << "end call derivative" << std::endl;
