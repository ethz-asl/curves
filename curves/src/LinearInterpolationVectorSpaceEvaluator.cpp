...
//LinearInterpolationVectorSpaceEvaluator::ValueType LinearInterpolationVectorSpaceEvaluator::evaluateDerivative(unsigned derivativeOrder,
//                                                                            const Coefficients& coefficients) const {
//  // \todo Abel and Renaud
...
//
///// Evaluate the curve derivatives (functional form).
//LinearInterpolationVectorSpaceEvaluator::ValueType LinearInterpolationVectorSpaceEvaluator::evaluateDerivativeAndJacobian(unsigned derivativeOrder,
